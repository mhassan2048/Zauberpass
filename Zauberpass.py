...
def draw_passmap_with_special_passes(df, team, game_info, player, data_type_option):
    ...
    for i, pass_type in enumerate(special_pass_colors.keys()):
        ...
        plt.figtext(0.1, 0.165 - i*0.03, f"{special_passes_count[pass_type]} successful, {special_passes_failed_count[pass_type]} failed", 
                    fontproperties=font_prop_small, color='white', ha='left')
